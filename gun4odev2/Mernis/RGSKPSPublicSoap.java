...
public class RGSKPSPublicSoap
{
    ...
    public RGSKPSPublicSoap(){}

    public RGSKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RGSKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RGSExtendedSoapSerializationEnvelope envelope= new RGSExtendedSoapSerializationEnvelope(RGSExtendedSoapSerializationEnvelope.VER11);
